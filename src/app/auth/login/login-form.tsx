...
import {
  Box, Flex, VStack, Text, Input, Button, Separator,
  Field,
  ...
  return (
    <VStack gap={6} w="full">
      ...
      <form onSubmit={handleSubmit} style={{ width: "100%", display: "flex", flexDirection: "column", gap: "16px" }}>
        ...
        {error && (
          <Text fontSize="13px" color="red.600" bg="red.50" px={4} py={3} borderRadius="xl">
            {error}
          </Text>
        )}
      ...
      <Flex align="center" gap={3} w="full">
        <Separator flex={1} />
        <Text fontSize="xs" color="gray.400">ou</Text>
        <Separator flex={1} />
      </Flex>
